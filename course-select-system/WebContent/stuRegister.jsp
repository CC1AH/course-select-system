      ...
      <!-- Main -->
        <div id="main">
          <div class="inner">
            ...
            <header id="header">
              <div class="logo">
                <a href="index.html">学生注册界面</a>
              </div>
            </header>
<form action="stuRegister" method="post" onsubmit="check(this)"> 
            <!-- Page Heading -->
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="banner-caption">
                            ...
                            <div class="col-md-12">
                          <fieldset>
                            <input name="stuID" type="text" class="form-control" id="name" placeholder="请输入学号" required="">
                          </fieldset>
                        </div>
							  <br>
							  <div class="col-md-12">
                          ...
                          <fieldset>
                            <input name="dept_name" type="text" class="form-control" id="name" placeholder="请输入系名" required="">
							  ...
							  <div class="col-md-12">
                          <fieldset>
                            <input name="tot_cred" type="text" class="form-control" id="name" placeholder="请输入总学分" required="">
                          </fieldset>
                        </div>
							  <br>
...
<table align="center" border="1" width="50%" cellpadding="6">  
	...
	<tr>
		<th colspan="2" align="center" >学生用户注册平台</th>
	</tr>
	<tr>
		<td align="center" >学        号：</td>   
		<td align="left" ><input type="text" name="stuID"></td>
	</tr>
	<tr>
	...
	<tr>
		<td align="center" >总    学    分：</td>
		<td align="left" ><input type="text" name="tot_cred"></td>
	</tr>
	<tr>
